#
#  Be sure to run `pod spec lint SQPersist.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Christopher Ney"
  # s.authors            = { "Christopher Ney" => "christopher.ney@gmail.com" }
  ...
  s.source_files  = "Classes", "SQPersist/**/*.{h,m}"
  # s.exclude_files = "Classes/Exclude"

  s.public_header_files = "SQPersist/**/*.h"
